...
var twilioPhone = function (accountSid, authToken) {
  ...
  function getNearbyPhoneNumber (deferred, nearPhoneNumber) {
    ...
    purchasePhoneNumber: function (phone) {
      ...
      twilio.incomingPhoneNumbers.create({ areaCode: areaCode })
        ...
        .catch(function (error) {
          ...
          //if no available phones for area code, purchase a nearby phone number.
          getNearbyPhoneNumber(deferred, nearPhoneNumber);
        });
      ...
      twilio.incomingPhoneNumbers.list()
        .then(function (result) {
          ...
          result.incomingPhoneNumbers.forEach(function (number) {
            promise = twilio.incomingPhoneNumbers(number.sid).delete();
